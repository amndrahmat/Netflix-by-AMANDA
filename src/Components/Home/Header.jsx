  ...
  return (
    <div className="flex flex-col relative text-center bg-gradient-to-r from-slate-900 via-slate-700 to-slate-600 border-b-8 border-neutral-800">
      <div className="flex w-full justify-between items-center absolute px-16 z-30">
        ...
        <div>
          <select className="h-8 bg-transparent text-white w-40 border border-white">
            {language.map((lang) => {
              return (
      ...
      <div className="absolute flex flex-col justify-center inset-0 text-center z-10">
        <h1 className="font-Sequel-Sans-Black text-5xl text-white font-bold tracking-normal no-underline pb-4">
          Unlimited movies, TV shows and more.
        </h1>
        <p className="text-white font-sans text-2xl font-normal tracking-normal no-underline pb-4">
          Watch anywhere. Cancel anytime.
        </p>
        <p className="text-white font-sans text-3l font-normal tracking-normal no-underline pb-4">
          Ready to watch? Enter your email to create or restart your membership.
        </p>
        <div className="flex justify-center items-center">
          <div>
            <input
              className="w-[800px] h-16 text-white outline-none border-0 pl-4"
              placeholder="Email address"
            ></input>
          </div>
          <div>
            <button className="bg-red-600 h-16 w-60 font-sans text-white cursor-pointer font-bold">
              Get Started
            </button>
          </div>
        </div>
